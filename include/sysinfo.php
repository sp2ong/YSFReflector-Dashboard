<?php
    ...
    $cpufreq = intval(trim(`lscpu |grep MHz|cut -f2 -d:`));
	}
	$mem_total = `free --mega|grep Mem:|cut -f2 -d:|awk '{print $1}'`;
	$mem_free = `free --mega|grep Mem:|cut -f2 -d:|awk '{print $3}'`;
...
<div class="panel panel-default">
  ...
  <div class="panel-heading-custom panel-heading">System Info</div>
  <!-- Tabelle -->
	<div class="table-responsive">  
		<table id="sysinfo" class="table table-condensed table-striped">
			<tbody>
				<tr>
					<?php
					if ($cputemp !== NULL) {
...
?>
					...
					<td></td>
					<td><?php echo $mem_total." / ".$mem_free; ?></td>
